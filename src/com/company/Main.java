        ...
        public static class Homework4 {
            ...
            public static void main(String[] args) {
                ...
                while (true) {
                    ...
                    if (g.isMapFull()) {
                        System.out.println("ИГРА ОКОНЧЕНА. НИКТО НЕ ПОБЕДИЛ");
                        break;
                    }
                    ...
                    if (g.checkWin(g.cpu1)) {
                        System.out.println("ИГРА ОКОНЧЕНА. ПРОЦЕССОР ЯВЛЯЕТСЯ ПОБЕДИТЕЛЕМ");
                        break;
                    }
                    if (g.isMapFull()) {
                        System.out.println("ИГРА ОКОНЧЕНА. НИКТО НЕ ПОБЕДИЛ");
            ...
            void aiTurn(char c) {
                ...
                System.out.println("поворот процессора с помощью [" + c + "]:");
